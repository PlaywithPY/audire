/**
 * Script pour peupler la table PageText avec tous les textes extraits
 * Usage: npx tsx scripts/populate-page-texts.ts
 */
...
async function main() {
  console.log('🚀 Peuplement de la table PageText...\n');
  ...
  for (const page of pageDefinitions) {
    ...
    for (const text of page.texts) {
      ...
      if (existing) {
        console.log(`  ⏭️  ${text.textKey} (existe déjà)`);
        skipped++;
      } else {
