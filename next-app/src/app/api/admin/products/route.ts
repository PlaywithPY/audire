  ...
  try {
    ...
    const product = await prisma.product.create({
      data: {
        ...
        order: order || 0,
        showBrand: showBrand !== undefined ? showBrand : true,
        showPrice: showPrice !== undefined ? showPrice : true,
        showShortDescription: showShortDescription !== undefined ? showShortDescription : true,
        showFullDescription: showFullDescription !== undefined ? showFullDescription : true,
        showImage: showImage !== undefined ? showImage : true,
        showFeatures: showFeatures !== undefined ? showFeatures : true,
        showProsCons: showProsCons !== undefined ? showProsCons : true,
        showDeviceType: showDeviceType !== undefined ? showDeviceType : true,
        showHearingLossLevel: showHearingLossLevel !== undefined ? showHearingLossLevel : true,
