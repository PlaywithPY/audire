...
CREATE INDEX "Centre_postalCode_idx" ON "Centre"("postalCode");
CREATE INDEX "Centre_isActive_idx" ON "Centre"("isActive");

-- Insert default centre to link existing hours
...
VALUES ('Audire Jemeppe', 'jemeppe', '+32 4 234 56 78', '+32 476 12 34 56', 'jemeppe@audire.be', E'Rue de la Station, 4\n4101 Jemeppe-sur-Meuse', '4101', 'Jemeppe-sur-Meuse', true, true, 50.6197, 5.4981, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

-- AddForeignKey - Add centreId column to OpeningHours with default value
...
CREATE UNIQUE INDEX "OpeningHours_centreId_dayOfWeek_key" ON "OpeningHours"("centreId", "dayOfWeek");
CREATE INDEX "OpeningHours_centreId_idx" ON "OpeningHours"("centreId");
